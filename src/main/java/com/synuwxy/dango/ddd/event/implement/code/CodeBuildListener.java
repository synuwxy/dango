package com.synuwxy.dango.ddd.event.implement.code;

import com.alibaba.fastjson.JSONObject;
import com.synuwxy.dango.ddd.aggreate.git.GitRepo;
import com.synuwxy.dango.ddd.aggreate.script.Script;
...
public class CodeBuildListener {
    ...
    @EventListener(condition = "#buildEvent.source instanceof T(com.synuwxy.dango.ddd.event.implement.code.CodeDefaultBuildCommand)")
    ...
    @EventListener(condition = "#buildEvent.source instanceof T(com.synuwxy.dango.ddd.event.implement.code.CodeCustomBuildCommand)")
